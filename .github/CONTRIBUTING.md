# Contributing to @qcloud-apaas/mobile-ui

The following is a set of guidelines for contributing to @qcloud-apaas/mobile-ui. Please spend several minutes in reading these guidelines before you create an issue or pull request.
...
```bash
git clone https://github.com/qcloud-apaas/mobile-ui.git
